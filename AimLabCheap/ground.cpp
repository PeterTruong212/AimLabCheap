...
void Ground::Init(const char* vertexShaderPath, const char* fragmentShaderPath) {
    shaderProgram = createShaderProgram(vertexShaderPath, fragmentShaderPath);
    createVertexArray();
    loadTexture("ground_texture.jpg");
}

void Ground::Draw(glm::mat4 projection, glm::mat4 view, unsigned int texture) {
